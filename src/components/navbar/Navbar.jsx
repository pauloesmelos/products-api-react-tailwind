    ...
    <header className="bg-white p-3 mb-10 shadow-lg font-sans w-full">
      <div className="flex justify-between gap-5 items-center">
        ...
        <div className="flex items-center gap-6 p-3">
          ...
          />
          <NavLink to="/">
            <h1 className="text-2xl md:text-4xl">Shopping <span className="font-bold text-blue-500">Web</span></h1>
          </NavLink>
        </div>
        {/* search product */}
        <div className="bg-gray-200 rounded-xl flex items-center p-2 w-full max-w-[300px] md:max-w-[500px] border-2 hover:border-blue-500">
          <IoSearch 
            className="hover:text-blue-700 duration-200 cursor-pointer"
            size={30} 
          />
          <input
            className="bg-transparent outline-none text-black placeholder:text-black px-3 w-full"
            type="text"
