...
const ProductCard = ({ data }) => {
  ...
  return (
    <NavLink
    className="w-full h-[300px] hover:shadow-lg bg-white rounded-lg p-2 flex flex-col duration-500 relative group" 
    to={`produto/${id}`}>
      ...
      <div className="overflow-hidden">
        <img
          className="w-full h-[250px] object-cover rounded-t-lg hover:scale-110 duration-500" 
          src={fotos[0].src} 
          alt={fotos[0].titulo} 
        ...
        <div>
          ...
          <p>Por: 
            <span className="text-green-600 ml-2">
              R$
              <span className="text-2xl">{preco - 9}</span>
            </span>
          </p>
        </div>
      </div>
